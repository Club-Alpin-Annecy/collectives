...
class Registration(db.Model):
    ...
    status = db.Column(db.Enum(RegistrationStatus), nullable=False)  # Active, Rejected...
    level = db.Column(db.Enum(RegistrationLevels), nullable=False)  # Co-encadrant, Normal
